...
> {
  ...
  /**
   * The initial state, same as Redux's legacy_createStore.
  ...
  */
  ...
  /**
   * The store enhancers to apply. See Redux's `legacy_createStore()`.
...
/**
 * A friendly abstraction over the standard Redux `legacy_createStore()` function.
 *
...
export function configureStore<
  ...
  return legacy_createStore(rootReducer, preloadedState, composedEnhancer)
}
